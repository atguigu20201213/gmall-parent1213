...
public class OrderServiceImpl extends ServiceImpl<OrderInfoMapper, OrderInfo> implements OrderService {
    ...
    public Long saveOrderInfo(OrderInfo orderInfo) {
        ...
        // 提交数据的 时候 缺少   总金额,用户Id  订单的交易编号，订单描述，创建时间 ，过期时间 ，进度的状态  ，物理单号（物流系统） 父订单ID(系统发生拆单的时候 图片路径
        // ，可以忽略)
        // 补充缺少的字段
    ...
    /**
     * @param tradeNo 页面传递过来的流水号
     * @param userId  从缓存中获取流水号 使用ley
     * @return`
     */
    @Override
    ...
    public void sendOrderStatus(Long orderId) {
        ...
        // 准备发送消息   EXCHANGE_DIRECT_WARE_STOCK 减库存的交换机   ROUTING_WARE_STOCK 减库存的路由
